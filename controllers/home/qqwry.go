...
func (this *QQwry) Find(ip string) {
	...
	conuntryUtf8, err := GbkToUtf8(country)
	if err != nil {
		fmt.Println("GbkToUtf8 country fail.err:", err)
		return
	}
	areaUtf8, err := GbkToUtf8(area)
	if err != nil {
		fmt.Println("GbkToUtf8 area fail.err:", err)
		return
	}
	this.Country = string(conuntryUtf8)
	this.City = string(areaUtf8)
